...
@WebServlet(name = "InteraccionJSON", 
        urlPatterns = {"/Interaccion/Linea.json"})


public class InteraccionJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if ( request.getParameter("id") != null) 
            {
                ...
                instancia = (Interaccion) persistencia.filtrarId(instancia, codigo);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(InteraccionJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
