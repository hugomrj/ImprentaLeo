...
@WebServlet(name = "Interaccion_Coleccion_Lista", 
        urlPatterns = {"/Interaccion/Coleccion/Lista"})


public class Interaccion_Coleccion_Lista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/Sistema/Interaccion/jspf/basictable.jspx").include(request, response);                
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Interaccion_Coleccion_Lista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
