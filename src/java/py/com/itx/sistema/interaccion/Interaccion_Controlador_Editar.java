...
@WebServlet(name = "Interaccion_Controlador_Editar",
        urlPatterns = {"/Interaccion/Controlador/Editar"})


public class Interaccion_Controlador_Editar extends HttpServlet {
