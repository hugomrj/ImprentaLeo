...
@WebServlet(name = "Usuario_Controlador_Agregar",
        urlPatterns = {"/Usuario/Controlador/Agregar"})


public class Usuario_Controlador_Agregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            instancia = (Usuario) persistencia.insert(instancia);
