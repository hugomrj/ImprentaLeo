 ...
 * @author hugo
 */
@WebServlet(name = "OrdenTrabajoDetalle_Transaccion_JSON", 
        urlPatterns = {"/OrdenTrabajoDetalle/Transaccion.json"})


public class OrdenTrabajoDetalle_Transaccion_JSON extends HttpServlet {
            ...
            {        
                ...
                if ( request.getParameter("id") != null) 
                {
                    ...
                    try
                    {
                        ...
                        instancia = (OrdenTrabajoDetalle) ordenesDetalles.get(id);                
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(OrdenTrabajoDetalle_Transaccion_JSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
