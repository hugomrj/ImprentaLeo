...
@WebServlet(name = "OrdenTrabajoDetalle_Transaccion_Count",
        urlPatterns = {"/OrdenTrabajoDetalle/Transaccion/Count"})


public class OrdenTrabajoDetalle_Transaccion_Count extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(OrdenTrabajoDetalle_Transaccion_Count.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
