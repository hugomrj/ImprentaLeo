...
@WebServlet(name = "OrdenTrabajoDetalle_Transaccion_Borrar",
        urlPatterns = {"/OrdenTrabajoDetalle/Transaccion/Borrar"})


public class OrdenTrabajoDetalle_Transaccion_Borrar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(OrdenTrabajoDetalle_Transaccion_Borrar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
